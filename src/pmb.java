...
public class pmb {
    ...
    public static void PrintInfoMahasiswaBaru(){
        ...
        for(int index=0;index< Komputer.length;index++){
            if(Komputer[index]  !=null){
                jumlahDkv++;
            }
        }
        jumlahSisa= totalJumlahMahasiswaBaru - jumlahInformatika - jumlahDkv - jumlahKomputer;
        System.out.println("jumlah maba Informatika : " + jumlahInformatika + " | jumlah Maba Dkv: " + jumlahDkv + " | jumlah Maba Komputer: " + jumlahKomputer);
